...
public class App{
    ...
    static ArrayList<Transaksi> Trnsksi = new ArrayList<>();
    public static void main(String[] args) throws IOException{
        ...
        while (isRunning) {
            ...
            System.out.println("5. Lihat Harga");
            System.out.println("6. Tipe transaksi");
            System.out.println("7. Keluar Store");
    ...
    public static void lihatharga()throws IOException {
        ...
        if(menu == 1 ){
            for (int i = 0; i < pcList.size(); i++) {
                pc pclist = pcList.get(i);
                String nama = pclist.getName();
                int harga = pclist.getPrice();
                pclist.DataPenjualanProduk(nama);
                pclist.DataPenjualanProduk(harga);
            }
        }else{
    ...
    public static void showAllItems() throws IOException{
        ...
        if(menu == 1 ){
            for (int i = 0; i < pcList.size(); i++) {
                ...
                System.out.println("Kodepromo :" + pcList.get(i).getKodepromo());
            }
        }else{
            for (int i = 0; i < mobileList.size(); i++) {
                System.out.println((i+1) + ". " + mobileList.get(i).toString());
                System.out.println("Kodepromo :" + mobileList.get(i).getKodepromo());
            }
        }
    }
    ...
    public static void tambahTipeTransaksi() throws IOException{
        System.out.println("         Tambahkan Tipe Transaksi        ");
        int idtransaksi = Trnsksi.size() + 1;
